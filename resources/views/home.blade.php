    ...
    <div class="max-w-xl mx-auto text-center px-4 mb-8 text-gray-600 text-lg leading-7">
        ...
        <p class="mb-4">
            <a href="https://twitter.com/freekmurze">
                <img src="/freek.jpg" width="150" class="rounded-full border-4 border-white shadow-lg enlarge inline-block" alt="Freek Van der Herten">
            </a>
        </p>
    ...
    <div class="bg-50">
        <a id="newsletter">
            <div class="max-w-screen-xl mx-auto px-4 py-12 sm:px-6 lg:py-16 lg:px-8">
                @if(session()->has('email-submitted'))
                ...
                <div class="px-6 py-6 bg-red-500 rounded-lg md:py-12 md:px-12 lg:py-16 lg:px-16 xl:flex xl:items-center">
                    ...
                    <div class="mt-8 sm:w-full sm:max-w-md xl:mt-0 xl:ml-8">
                        <form action="{{ route('subscribe') }}" method="POST" class="sm:flex">
                            @csrf
                            @honeypot
                            @method('POST')
